      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={`md:flex ${dropdownOpen ? 'flex' : 'hidden'}`} id="navbar-dropdown">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link to="/" className="block py-2 px-3 text-white bg-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 md:dark:text-green-500 dark:bg-green-600 md:dark:bg-transparent" aria-current="page">Home</Link>
            </li>
            <li>
              <button
                id="dropdownNavbarLink"
                onClick={toggleDropdown}
                className="flex items-center justify-between w-full py-2 px-3 text-green-900 rounded hover:bg-green-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 md:w-auto dark:text-green md:dark:hover:text-green-500 dark:focus:text-green dark:border-green-700 dark:hover:bg-green-700 md:dark:hover:bg-transparent"
              >
                More
            ...
            <li>
              <Link to="/Myorders" className="block py-2 px-3 text-green-900 rounded hover:bg-green-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-green md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-green md:dark:hover:bg-transparent">My Orders</Link>
            </li>
            <li>
              <Link to="/about" className="block py-2 px-3 text-green-900 rounded hover:bg-green-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-green md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-green md:dark:hover:bg-transparent">About</Link>
            </li>
          </ul>
        </div>
      </div>
